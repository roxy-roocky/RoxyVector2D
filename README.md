...
- Grid snap settings don't affect the arrow because I cannot, currently, access to your grid snap settings. When hold *Ctrl/Cmd* during moving arrow, it snaps to a fixed grid (4px).
